...
[a{1},~,~]=xlsread('eurusdn1-1000.xlsx');
[a{2},~,~]=xlsread('eurusdn2-1000.xlsx'); 
[a{3},~,~]=xlsread('eurusdn3-1000.xlsx'); 
[a{4},~,~]=xlsread('eurusdn3-1000.xlsx'); 
[a{5},~,~]=xlsread('gbpusdn1-1000.xlsx'); 

%read in currencies for comparison
[a{6},~,~]=xlsread('gbpusdn2-1000.xlsx');
[a{7},~,~]=xlsread('gbpusdn3-1000.xlsx');

[a{8},~,~]=xlsread('usdchfn1-1000.xlsx'); 
[a{9},~,~]=xlsread('usdchfn2-1000.xlsx'); 
[a{10},~,~]=xlsread('usdchfn3-1000.xlsx'); 
...
inputs=struct('vol',{vol},'rsi',{rsi},'curr',{curr},'curr2',{curr}); 
...
for n=1:numnet; 
    for k=1:numdelay; 
     resultstog{n}(:,:,k)=resultstog{n}(:,:,k)/(1000-period-(k*stepsized+mind-stepsized)-1); 
     resultsdiff{n}(:,:,k)=resultsdiff{n}(:,:,k)/(1000-period-(k*stepsized+mind-stepsized)-1); 
    end
end
...
r11iresults=iresults; 


save('r11iresults','r11iresults')
...
r11avresults=avresults; 
save('r11avresults','r11avresults')
