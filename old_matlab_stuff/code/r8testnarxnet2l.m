...
%defining indices
numdelay=j/stepsized-mind/stepsized+1; 
numhid2=i/stepsizen2-minn2/stepsizen2+1;
numhid1=h/stepsizen1-minn1/stepsizen1+1; 
...
for n=1:numnet; 
    for k=1:numdelay; 
     resultstog{n}(:,:,k)=resultstog{n}(:,:,k)/(500-(k*stepsized+mind-stepsized)-1); 
     resultsdiff{n}(:,:,k)=resultsdiff{n}(:,:,k)/(500-(k*stepsized+mind-stepsized)-1);  
    end
end
...
r8iresults2l=iresults; 

save('r8iresults2l','r8iresults2l')
...
r8avresults2l=avresults; 
save('r8avresults2l','r8avresults2l')
